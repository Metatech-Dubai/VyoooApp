  ...
  static ThemeData get dark {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        bodyLarge: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w400),
        bodyMedium: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w400),
        bodySmall: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w400),
        titleLarge: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w700),
        titleMedium: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w500),
        titleSmall: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w400),
        labelLarge: TextStyle(color: defaultTextColor, fontWeight: FontWeight.w500),
      ),
      inputDecorationTheme: InputDecorationTheme(
        filled: false,
        fillColor: Colors.transparent,
        contentPadding: const EdgeInsets.symmetric(vertical: AppSpacing.storyItem),
        hintStyle: const TextStyle(color: hintTextColor, fontSize: 16, fontWeight: FontWeight.w400),
        labelStyle: const TextStyle(color: defaultTextColor, fontSize: 16),
        floatingLabelStyle: const TextStyle(color: defaultTextColor, fontSize: 16),
